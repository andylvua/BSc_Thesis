...
\begin{figure}[tbh]
    ...
    \subfloat[Dataset collection environment]{%
        \includegraphics[height=6.5cm]{Graphics/room.JPG}
        \label{fig:environment}
    }
    \subfloat[UWB Tag][UWB Tag]{%
        \includegraphics[height=6.5cm]{Graphics/tag.png}
        \label{fig:tag}
    }
...
The following part of this section will discuss each of them separately.
...
\paragraph{CIR Acquisition and Encoding}
...
% TODO!: calculate improvement for 136 samples used everywhere
